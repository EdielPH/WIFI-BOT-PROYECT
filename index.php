                              ...
                              <div class="owl-carousel owl-theme">
                                   <div class="item">
                                        ...
                                        <div class="testimonial-item">
                                             <img src="images/tst-image1.jpg" class="img-responsive" alt="Ediel">
                                             <h4>Ediel</h4>
                                        </div>
                                   </div>
                                   ...
                                   <div class="item">
                                        ...
                                        <div class="testimonial-item">
                                             <img src="images/tst-image2.jpg" class="img-responsive" alt="Eddie">
                                             <h4>Eddie</h4>
                                        </div>
                                   </div>
                                   ...
                                   <div class="item">
                                        ...
                                        <div class="testimonial-item">
                                             <img src="images/tst-image3.jpg" class="img-responsive" alt="Arthur">
                                             <h4>Arthur</h4>
                                        </div>
                                   </div>
                              </div>
               ...
               <div class="row">
                    ...
                    <div class="col-md-offset-1 col-md-10 col-sm-12">
                         <form id="contact-form" role="form" action="" method="post">
                              ...
                              <div>
                                   <button type="button" class="btn btn-outline-success">Comencemos!</button>
                              </div>
